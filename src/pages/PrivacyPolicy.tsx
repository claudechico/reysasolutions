...
const PRIVACY_POLICY_TEXT = `This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
...
Application refers to AMA, the software program provided by the Company.

Company (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Reysa Solutions Company Limited, Mbezi Beach, Dar es Salaam, Tanzania.
...
We use this information to provide features of Our Service, to improve and customize your experience. The information may be uploaded to the Company's servers and/or a Service Provider's server or it may be simply stored on Your device.
...
By email: reysasolutionstz@gmail.com

By visiting this page on our website: https://reysasolutions.co.tz/contact

By phone: +255 684 304 594`;
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            <button
              type="button"
              onClick={() => navigate('/')}
              className="flex-1 bg-white border border-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-50 transition text-sm font-medium"
            >
              Back to Home
            </button>
            <button
              ...
              className="flex-1 bg-gradient-to-r from-dark-blue-500 to-dark-blue-600 text-white px-6 py-3 rounded-lg hover:from-dark-blue-600 hover:to-dark-blue-700 transition text-sm font-medium"
            >
              Contact Us
            </button>
          </div>
